                    ...
                    children=[
                            ...
                            children=[
                                ...
                                dmc.Modal(
                                    ...
                                    children=[
                                        ...
                                        dmc.Center(
                                            _tooltip(
                                                "Exports annotations as a mask to user's machine",
                                                children=dmc.Button(
                                                    "Export annotation",
                        ...
                        _accordion_item(
                            ...
                            children=[
                                dmc.Center(
                                    _tooltip(
                                        "Send annotation mask to server to run ML model",
                                        children=dmc.Button(
                                            "Run model",
                                            id="run-model",
                                            disabled=True,
                                ...
                                dmc.Space(h=25),
                                _tooltip(
                                    text="Overlays the ML segmentation results on the image",
                                    children=dmc.Switch(
                                ...
                                _control_item(
                                    ...
                                    "",
                                    _tooltip(
                                        text="ML segmentation results can be selected here",
                                        children=dmc.Select(
                                            id="result-selector",
